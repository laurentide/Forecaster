...
Public Class ProductCode
    ...
    Dim FY09Actual_Details As Decimal
    Dim FY10Actual_Details As Decimal
    Dim FY11Budget_Details As Decimal
    ...
    Protected Function AddGroupingRowIfTeamHasChanged() As String
        ...
        If lastteamNameValue <> currentteamNameValue Or lastApprovedValue <> currentApprovedValue Then
            ...
            Return String.Format("<tr class=""group""><td colspan=""6"">Team: {0} - Budget Status: {1} </td></tr>", currentteamNameValue, currentApprovedValue)
        Else
