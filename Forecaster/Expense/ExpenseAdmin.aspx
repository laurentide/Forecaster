<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/FunnelSite.Master" CodeBehind="ExpenseAdmin.aspx.vb" Inherits="Forecaster.ExpenseAdmin" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Expense Report Administration</h2>
    <asp:ScriptManager ID="ScriptManager" runat="server" />
    <asp:FormView runat="server" ID="frmExpense" DefaultMode="Edit" DataKeyNames="ExpenseReportID" DataSourceID="sdsForm" 
...
<%--                                        <tr>
                ...
                <tr><td colspan ="2" style="font-weight:bold;">Admin Section</td></tr>
                 <tr>
                    <td>Paid
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="PayDatesDropDown" runat="server" DataSourceID="sdsPayDates" AppendDataBoundItems="true" DataValueField="PaidDateID" DataTextFormatString="{0:d}" DataTextField="PaidDate" SelectedValue='<%# Bind("PaidDateID")%>'>
                            <asp:ListItem Text="(Select a pay date)" Value="" />
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
    ...
    <asp:Panel ID="Panel2" runat="server">
        <asp:FormView ID="FormView2" runat="server" DataSourceID="sdsExchangeRate" DefaultMode="Edit" BackColor="#C4CAFF">
            <EditItemTemplate>
 ...
 WHERE ExpenseReportID = @ExpenseReportID"
    ...
    <asp:SqlDataSource ID="sdsExpenseReportGrid" runat="server" ConnectionString="<%$ ConnectionStrings:ExpenseReportConnectionString %>"
        SelectCommand="SELECT *, left(businesspurpose,25) as shortBusiness
              ...
              where visible = 1
               and @Username in (select adminusername from tbladminmembers)
