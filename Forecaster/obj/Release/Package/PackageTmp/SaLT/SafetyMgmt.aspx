            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" validationgroup="Update" ForeColor="Red" ErrorMessage="Select the type" ControlToValidate="TypeDropDown" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" validationgroup="Update" ForeColor="Red" ErrorMessage="Select the cause" ControlToValidate="SafetyCauseDrowDown" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Update" ForeColor="Red" ErrorMessage="Name required" ControlToValidate="IssuedByTextBox" />
                    </td>
                </tr>
                <tr>
                    <td>Email:
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="Update" ForeColor="Red" ErrorMessage="Email required" ControlToValidate="IssuedByEmailTextBox" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="Update" ForeColor="Red" ErrorMessage="Circumstances required" ControlToValidate="CircumstancesTextBox" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="Update" ForeColor="Red" ErrorMessage="Suspected root cause required" ControlToValidate="SuspectedRootCauseTextbox" />
                    </td>
                    
                </tr>
                <tr><td><h5>SaLT TEAM</h5></td></tr>
                <tr>
                    <td>Status:
                    </td>
                    <td>
                ...
                <tr>
                    <td>Assign to (SaLT member):
                    </td>
                    <td>
                        <asp:DropDownList ID="SaLtMemberDropDown" runat="server" DataSourceID="sdsSaLTMembers" AppendDataBoundItems="true" DataValueField="SaLTMemberID" DataTextField="SaLTMember" SelectedValue='<%# Bind("SaLTMemberID")%>'>
