<%@ Page Title="Segments and Customers" Language="vb" MasterPageFile="~/FunnelSite.Master" AutoEventWireup="false" CodeBehind="Funnel_PSS.aspx.vb" Inherits="Forecaster.Funnel_PSS" %>
...
where a.opportunityid in (select distinct opportunityid
                           ...
                           where (funnelproductid = 9 and total &gt; 0))
