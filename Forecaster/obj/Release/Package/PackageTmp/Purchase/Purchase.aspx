...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Insert" ErrorMessage="Name of requester required" ControlToValidate="RequesterNameTextBox" />
                    </td>
                </tr>
                <%--                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Insert" ErrorMessage="Email of requester required" ControlToValidate="RequesterEmailTextBox" />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="Insert" ErrorMessage="Enter a valid email" ControlToValidate="RequesterEmailTextBox" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" />
                    </td>
                </tr>
                <tr>
                    <td>Department:
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ValidationGroup="Insert" ErrorMessage="Select your department" ControlToValidate="DepartmentDropDown" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup="Insert" ErrorMessage="Select your manager" ControlToValidate="ManagerDropDown" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="Insert" ErrorMessage="Item name required" ControlToValidate="ItemNameTextBox" />
                    </td>
                </tr>
                <tr>
                    <td>Description:
                    ...
                    <td>
                        <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' TextMode="MultiLine" Height="100" Width="500" />
                    </td>
                </tr>
                <tr>
                    <td>Reason:
                    ...
                    <td>
                        <asp:TextBox ID="ReasonTextBox" runat="server" Text='<%# Bind("Reason") %>' TextMode="MultiLine" Height="100" Width="500" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="Insert" ErrorMessage="Reason required" ControlToValidate="ReasonTextBox" />
                    </td>
                </tr>
                <tr>
                    <td>Quantity:
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Insert" ErrorMessage="Quantity required" ControlToValidate="QuantityTextBox" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="Insert" ErrorMessage="Price required" ControlToValidate="TotalPriceTextBox" />
                    </td>
                </tr>
                <%--                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="Insert" ErrorMessage="Select the purpose of your purchase" ControlToValidate="ApprovalDropDown" />
    ...
    <asp:GridView ID="gvPurchaseRequests" runat="server" AutoGenerateColumns="False" DataKeyNames="PurchaseRequestID" DataSourceID="sdsPurchaseRequestsGrid" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ManagerApprovalDate" HeaderText="Manager Approval Date" SortExpression="ManagerApprovalDate" />
    ...
    <asp:SqlDataSource ID="sdsInsert" runat="server"
     ...
     VALUES
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Approved" DefaultValue="false" />
    ...
    <asp:SqlDataSource ID="sdsPurchaseRequestsGrid" runat="server" ConnectionString="<%$ ConnectionStrings:PurchaseRequestConnectionString %>"
        SelectCommand="SELECT     tblPurchaseRequests.*, tblManagers.ManagerName, tblDepartments.DepartmentName
                        FROM         tblPurchaseRequests INNER JOIN
                                              tblDepartments ON tblPurchaseRequests.DepartmentID = tblDepartments.DepartmentID INNER JOIN
        ...
        DeleteCommand="Delete from tblpurchaseRequests where purchaserequestid = @PurchaseRequestID">
        <SelectParameters>
