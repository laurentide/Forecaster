...
Public Class Safety
    ...
    Protected Sub frmInsert_ItemInserted(sender As Object, e As FormViewInsertedEventArgs)
        Try
            ...
            Dim mm As New MailMessage(CType(frmInsert.FindControl("IssuedByEmailTextBox"), TextBox).Text, "ddnguyen@laurentide.com", "New Safety case issued by " & CType(frmInsert.FindControl("IssuedByTextBox"), TextBox).Text, body)
